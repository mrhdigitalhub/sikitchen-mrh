      ...
      <div className="bg-white rounded-xl border shadow-sm p-4">
        ...
        <form onSubmit={tambahRencana} className="bg-slate-50 p-4 rounded-xl border">
          <div className="grid grid-cols-12 gap-3 items-end">
            ...
            <div className="col-span-3"><label className="text-[11px] font-bold text-slate-700 mb-1 block">[Nama Menu]</label><input placeholder="Ayam Bakar Madu (200 Porsi)" value={form.nama} onChange={e=>setForm({...form, nama:e.target.value})} className="w-full border p-2.5 rounded-lg text-xs bg-white" required /></div>
            <div className="col-span-1"><label className="text-[11px] font-bold text-slate-700 mb-1 block">[Porsi]</label><input type="number" placeholder="100" value={form.porsi} onChange={e=>setForm({...form, porsi:Number(e.target.value)})} className="w-full border p-2.5 rounded-lg text-xs bg-white text-center" /></div>
            <div className="col-span-1"><label className="text-[11px] font-bold text-slate-700 mb-1 block">[Manpower]</label><input type="number" placeholder="2" value={form.manpower} onChange={e=>setForm({...form, manpower:Number(e.target.value)})} className="w-full border p-2.5 rounded-lg text-xs bg-white text-center" /></div>
            ...
            <div className="col-span-2"><label className="text-[11px] font-bold text-slate-700 mb-1 block">[Bahan]</label><input placeholder="Bahan: Ayam 20kg, Madu 2L" value={form.bahan} onChange={e=>setForm({...form, bahan:e.target.value})} className="w-full border p-2.5 rounded-lg text-xs bg-white" /></div>
