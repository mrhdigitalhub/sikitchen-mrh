...
NOTIFY pgrst, 'reload schema';`}
      ...
      <div className="bg-white rounded-xl border shadow-sm overflow-hidden">
        <div className="bg-slate-100 px-5 py-3 font-bold flex justify-between items-center" style={{fontSize:'14px'}}><span>📜 History Order ({orders.length}) - Tidak Hilang!</span><button onClick={()=>loadAll()} className="bg-white border px-3 py-1 rounded-full text-[12px]">🔄 Refresh</button></div>
